...
const ProjectCard = ({title, summary, image, slug}) => {
    return (
            <a href={"./" + slug} className='bg-white text-default-400 rounded-lg shadow-lg flex flex-col transition transform hover:-translate-y-[0.25rem] hover:-translate-x-[-0.25rem] duration-300 motion-reduce:transition-none motion-reduce:transform-none'>
                ...
                <p>{summary}</p>
                <OutlineButton text="View on Github"/>
                </div>
            </a>
    )
}
